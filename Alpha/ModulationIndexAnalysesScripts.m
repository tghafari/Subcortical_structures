...
mkdir([saveFolder filesep 'Sub' num2str(subj)])
save([saveFolder filesep 'Sub' num2str(subj) filesep 'MI_Data'],'MI_L','MI_R','MI_overTime_inROI_L','MI_overTime_inROI_R');
save([saveFolder filesep 'Sub' num2str(subj) filesep 'All_Data'],'TFR_attRight_LF_chanSlctd_R','TFR_attRight_LF_chanSlctd_L',...
